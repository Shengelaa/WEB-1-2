...
// const index = users.findIndex((user) => user.username === "Moriah.Stanton");

// console.log(users[index], "user");

// const index1 = users.every((user) => user.name.length > 11);
...
const index = users.findIndex((el) => el.email === "Karley_Dach@jasper.info");
...
for (let i = 0; i < users.length, i++; ) {
  console.log(users[i], "users in classic for");
}
...
const totalByCurrency = transaction.reduce((acc, curr) => {
